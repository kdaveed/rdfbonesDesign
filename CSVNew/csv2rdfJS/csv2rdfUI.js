var csv2rdfUI = {
	...
	initiateMapping : function(columnName, list) {
		...
		mappingContainer.append(titleContainer).append(tableContainer).append(saveButton)
	...
	setInstanceSelectState : function() {
		$('.instancesDiv').css("border", "2px solid red")
